...
router.get('/:id/care-recommendation-history', protect, restrictTo('field_officer', 'manager'), floraController.getCareRecommendationHistory); // Care recommendation version history
